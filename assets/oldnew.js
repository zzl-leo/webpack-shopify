 ...
 * @LastEditTime: 2022-06-16 14:55:25
 * @LastEditors: Leo
 * @Description: 设置: 
 */
    	...
    	init: function(option) {
    		...
    		if (option.open === 'show') {
				...
				if (this.animation === 'up') {
					document.querySelector('.'+this.animation+'' + ' .modal-dialog').style.top = this._isUserAgentIE() ? '250px' : '0px';
				} else if (this.animation === 'soak') {
					document.querySelector('.'+this.animation+'' + ' .modal-dialog').style.top = '250px';
				}	    		
